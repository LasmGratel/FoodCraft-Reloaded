package cc.lasmgratel.foodcraftreloaded.client.util;
...
public class FluidStackRenderer {
    ...
    public List<String> getTooltip(Minecraft minecraft, FluidStack fluidStack, ITooltipFlag tooltipFlag) {
        ...
        if (tooltipMode == TooltipMode.SHOW_AMOUNT_AND_CAPACITY) {
            String amount = Translator.format("jei.tooltip.liquid.amount.with.capacity", fluidStack.amount, capacityMb);
            tooltip.add(TextFormatting.GRAY + amount);
        } else if (tooltipMode == TooltipMode.SHOW_AMOUNT) {
            String amount = Translator.format("jei.tooltip.liquid.amount", fluidStack.amount);
            tooltip.add(TextFormatting.GRAY + amount);
        }
