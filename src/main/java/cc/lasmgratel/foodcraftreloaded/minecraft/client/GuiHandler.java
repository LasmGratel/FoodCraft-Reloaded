...
import static cc.lasmgratel.foodcraftreloaded.minecraft.client.EnumGui.values;

public class GuiHandler implements IGuiHandler {
    public GuiHandler() {
        NetworkRegistry.INSTANCE.registerGuiHandler(FoodCraftReloadedMod.INSTANCE, this);
    }
