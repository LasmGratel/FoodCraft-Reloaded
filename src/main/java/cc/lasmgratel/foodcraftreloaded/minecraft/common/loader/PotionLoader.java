...
import cc.lasmgratel.foodcraftreloaded.minecraft.common.util.loader.annotation.RegPotion;
    ...
    public PotionLoader() {
        for (Field field : FCRPotions.class.getFields()) {
            ...
            try {
                ...
                if (anno == null)
                    continue;
                potion.setRegistryName(FoodCraftReloadedMod.MODID, NameBuilder.buildRegistryName(anno.value()));
