...
import cc.lasmgratel.foodcraftreloaded.minecraft.common.item.food.ItemGeneratedLiqueur;
import cc.lasmgratel.foodcraftreloaded.minecraft.common.loader.LiqueurLoader;
...
public class RegisterLoader {
    ...
    public void registerModel(ModelRegistryEvent event) {
        ...
        FoodCraftReloadedMod.getLoader(LiqueurLoader.class).get().loadRenders();
    }
}
