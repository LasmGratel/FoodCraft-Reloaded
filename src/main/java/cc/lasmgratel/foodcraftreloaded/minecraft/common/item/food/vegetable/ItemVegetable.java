...
import cc.lasmgratel.foodcraftreloaded.minecraft.common.block.BlockVegetableCrop;
...
public class ItemVegetable extends FCRItemFood implements VegetableTyped, CustomModelMasking, IPlantable, OreDictated {
    ...
    public ItemVegetable(VegetableType vegetableType) {
        ...
        setRegistryName(FoodCraftReloadedMod.MODID, vegetableType.toString());
    ...
    public ModelResourceLocation getModelLocation() {
        return new ModelResourceLocation(new ResourceLocation(FoodCraftReloadedMod.MODID, NameBuilder.buildRegistryName("vegetable", vegetableType.toString())), "inventory");
    }
    ...
    public IBlockState getPlant(IBlockAccess world, BlockPos pos) {
        return FoodCraftReloadedMod.getLoader(VegetableEnumLoader.class).get().getInstanceMap(BlockVegetableCrop.class).get(vegetableType).getDefaultState();
    }
}
