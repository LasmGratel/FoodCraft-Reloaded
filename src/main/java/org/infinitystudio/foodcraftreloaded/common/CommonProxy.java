...
public class CommonProxy {
    protected static final ModManager manager = new ModManager(
            ...
            CommonModManagement.TILEENTITY, CommonModManagement.FRUITSODA, CommonModManagement.JUICEFLUID,
            CommonModManagement.BLOCKJUICEFLUID, CommonModManagement.VEGETABLEBLOCK
    );
